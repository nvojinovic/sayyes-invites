...
// All images are served from /ivana-dimitrije/
const BASE = "/ivana-dimitrije";

const proposalImage = `${BASE}/couple-3.jpeg`;
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              background: "linear-gradient(180deg, #efe6d6 0%, #e3d6c0 100%)",
            }}
          />
          {/* Side folds */}
          <div
            ...
            style={{
              ...
              background: "linear-gradient(90deg, #f1e8d8 0%, #e8dcc6 100%)",
            }}
          />
          <div
            ...
            style={{
              ...
              background: "linear-gradient(270deg, #f1e8d8 0%, #e8dcc6 100%)",
            }}
          />
          ...
          <motion.div
            ...
            style={{
              ...
              background: "linear-gradient(180deg, #efe6d6 0%, #d9c9ac 100%)",
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          {locations.map((loc, idx) => (
            ...
            >
              <div className="relative h-56 overflow-hidden bg-sage-100">
                <img
                  src={loc.img}
                  alt={loc.title}
...
function Footer() {
  return (
    <footer className="px-6 pb-16 pt-4 text-center">
      ...
      <div className="mt-10 border-t border-sage-200/50 pt-6">
        <p className="text-[0.65rem] text-sage-500/70">
          Izradio{" "}
          <a
            href="https://sayyesinvites.com"
            target="_blank"
            rel="noopener noreferrer"
            className="font-medium text-sage-600/80 underline-offset-2 hover:underline"
          >
            SayYesInvites.com
          </a>
        </p>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-1 inline-block text-[0.65rem] text-sage-500/60 underline-offset-2 hover:text-sage-600/80 hover:underline"
        >
          Želiš svoju? Klikni ovde
        </a>
      </div>
    </footer>
  );
