...
const assetPath = (fileName: string) => `/ivana-dimitrije/${fileName}`;

const proposalImage = assetPath("couple-3.jpeg");

const galleryImages = [
  assetPath("couple-1.jpeg"),
  assetPath("couple-2.jpeg"),
  assetPath("couple-4.jpeg"),
];
...
const locations = [
  {
    ...
    time: "12:30",
    img: assetPath("oficirski-dom.jpg"),
  ...
  return (
    <footer className="px-6 pb-16 pt-4 text-center">
      ...
      <div className="mt-10 border-t border-sage-200/50 pt-6">
        <p className="text-xs text-sage-500/70 sm:text-sm">
          Izradio{" "}
          <a
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-2 inline-block text-xs text-sage-500/60 underline-offset-2 hover:text-sage-600/80 hover:underline sm:text-sm"
        >
